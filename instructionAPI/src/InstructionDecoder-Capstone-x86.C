...
void InstructionDecoder_Capstone::decodeOperands_x86(const Instruction* insn, cs_detail *d) {
    ...
    MachRegister (InstructionDecoder_Capstone::*regTrans)(x86_reg);
    if (m_Arch == Arch_x86)
        regTrans = &InstructionDecoder_Capstone::registerTranslation_x86_32;
    else
        regTrans = &InstructionDecoder_Capstone::registerTranslation_x86_64;
        ...
        if (operand->type == X86_OP_REG) {
	     ...
	     if (mem->base == X86_REG_RIP || mem->base == X86_REG_IP) usePC = true;
             ...
             if (mem->index != X86_REG_INVALID) {
                 Expression::Ptr indexAST = makeRegisterExpression((this->*regTrans)(mem->index));
...
MachRegister InstructionDecoder_Capstone::registerTranslation_x86_32(x86_reg cap_reg) {
    switch (cap_reg) {
        case X86_REG_AH:
            return x86::ah;
        case X86_REG_AL:
...
MachRegister InstructionDecoder_Capstone::registerTranslation_x86_64(x86_reg cap_reg) {
    switch (cap_reg) {
        case X86_REG_AH:
            return x86_64::ah;
        case X86_REG_AL:
