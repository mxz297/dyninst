...
dyn_tls dyn_hash_map<std::string, std::string> InstructionDecoder_Capstone::opcode_alias = {
    {"ja",  "jnbe"},
    {"jae", "jnb"},
    {"je", "jz"},
    {"jne", "jnz"},
...
dyn_tls dyn_hash_map<entryID, std::string> InstructionDecoder_Capstone::opcode_str {
    {e_aaa,"aaa"},
    {e_aad,"aad"},
    {e_aam,"aam"},
    {e_aas,"aas"},
