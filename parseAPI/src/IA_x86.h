...
class IA_x86 : public IA_IAPI {
    public:
        IA_x86(Dyninst::InstructionAPI::InstructionDecoder dec_,
               Address start_, 
	...
	virtual bool isTailCall(const ParseAPI::Function* context, ParseAPI::EdgeTypeEnum type, unsigned int,
	...
	bool pushPopSequenceMatch(const ParseAPI::Function*) const;
};
