...
// For forked process
edge_instance::edge_instance(edge_instance *parent,
                             mapped_object *child)
  : PatchEdge(parent,
...
// Cloning an edge within a process or binary rewriting
edge_instance::edge_instance(edge_instance* original, block_instance* src, block_instance* trg):
    PatchEdge(original, src, trg)
{}
